...
WebUI.scrollToElement(findTestObject('JetBlue Component Library Objects/standalone-link Component Objects/Page_JetBlue  Component Library/h3_Standalone Link no icon'), 
    10)
...
WebUI.click(findTestObject('JetBlue Component Library Objects/standalone-link Component Objects/Page_JetBlue  Component Library/a_Standalone link'))
...
WebUI.click(findTestObject('JetBlue Component Library Objects/standalone-link Component Objects/Page_JetBlue  Component Library/a_Standalone with icon link'))
