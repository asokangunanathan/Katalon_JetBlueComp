...
WebUI.scrollToElement(findTestObject('JetBlue Component Library Objects/CTA-link Component Objects/Page_JetBlue  Component Library/h3_Text CTA Links default'), 
    10)
...
WebUI.click(findTestObject('JetBlue Component Library Objects/CTA-link Component Objects/Page_JetBlue  Component Library/a_Default link CTA'))
...
// and scroll down to Simple Select Example
WebUI.scrollToElement(findTestObject('JetBlue Component Library Objects/CTA-link Component Objects/Page_JetBlue  Component Library/h3_Text CTA Links external'), 
    10)
...
WebUI.click(findTestObject('JetBlue Component Library Objects/CTA-link Component Objects/Page_JetBlue  Component Library/a_External link CTA'))
...
WebUI.click(findTestObject('JetBlue Component Library Objects/CTA-link Component Objects/Page_JetBlue  Component Library/a_Document link CTA'))
