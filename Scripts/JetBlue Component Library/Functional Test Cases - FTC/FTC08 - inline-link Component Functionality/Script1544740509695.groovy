...
WebUI.scrollToElement(findTestObject('JetBlue Component Library Objects/inline-link Component Objects/Page_JetBlue  Component Library/h3_Inline Link no icon'), 
    10)
...
WebUI.click(findTestObject('JetBlue Component Library Objects/inline-link Component Objects/Page_JetBlue  Component Library/a_Inline link'))
...
// and scroll down to Simple Select Example
WebUI.scrollToElement(findTestObject('JetBlue Component Library Objects/inline-link Component Objects/Page_JetBlue  Component Library/h3_Inline Links with icon'), 
    10)

WebUI.comment('then I should be able to see the "Inline Links: with icon" example and clicking on it should take me to /icons')

WebUI.click(findTestObject('JetBlue Component Library Objects/inline-link Component Objects/Page_JetBlue  Component Library/jb-icon_Inline link_pl1 t-fast'))
