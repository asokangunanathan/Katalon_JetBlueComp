...
def originalUrl = 'https://int.b6orgeng.net/component-library/typography/'+componentName    //****** Variable ****
...
def mimicUrl = 'https://dev.b6orgeng.net/component-library/typography/'+componentName    //****** Variable ****
