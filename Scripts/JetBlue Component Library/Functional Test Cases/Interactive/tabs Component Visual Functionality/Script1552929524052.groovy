...
//
WebUI.scrollToElement(findTestObject('Object Repository/JetBlue Component Library Objects/Interactive/tabs Component Objects/Page_JetBlue  Component Library/button_Item Two'),0)
...
WebUI.scrollToElement(findTestObject('Object Repository/JetBlue Component Library Objects/Interactive/tabs Component Objects/Page_JetBlue  Component Library/button_Item Three'),0)
...
WebUI.scrollToElement(findTestObject('Object Repository/JetBlue Component Library Objects/Interactive/tabs Component Objects/Page_JetBlue  Component Library/button_Consectetur adipis'),0)
...
WebUI.scrollToElement(findTestObject('Object Repository/JetBlue Component Library Objects/Interactive/tabs Component Objects/Page_JetBlue  Component Library/button_Hotels'),0)
...
//
File expectedFile = resolveScreenshotFile((("$browserName" + '_') + "$componentName") + '_expected_VFT.png' //****** Variable ****
	)
...
WebUI.waitForPageLoad(5)
//
File actualFile = resolveScreenshotFile((("$browserName" + '_') + "$componentName") + '_actual_VFT.png' //****** Variable ****
	)
...
File diffFile = resolveScreenshotFile((("$browserName" + '_') + "$componentName") + "_VFT_imageDiff(${dformat.format(diffRatioPercent)}).png" //****** Variable ****
	)
